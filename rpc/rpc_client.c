/*Este es el rpc cliente el cual contiene todas las peticiones que un usuario puede hacer 
 *en este protocolo de archivos, las funciones varian desde listar archivos consultarlos
 *hasta traerlos al directorio del cliente.*/
...
/*Funcion split que sirve para recibir una cadena de caracteres separada por algun simbolo, y devolver 
	...
	/*Este metodo se encarga del envio de la peticion del cliente al servidor UDP*/
	void dg_cli(FILE *fp, int sockfd, struct sockaddr *pservaddr, long servlen,char *informacion)
	{
	...
	/*Este metodo es quien no da la sensacion de estar en una shell, desde aqui se recibiran las peticiones
	 *del cliente y se aplicara la accion que sea esperada por el mismo.*/
 	int inicio()
 	{
 		char salida[256];
		printf(">>");
 	...
 	/*En caso de que el cliente digite "listar" en la shell este es el metodo que atendera la peticion
 	 *el servidor encargado de listar sera el UDP */
 	void listar()
 	{
 		int sockfd;
	...
	memset(informacion,0,256);
 	...
 	/*En caso de que el cliente digite "info<archivox.ejemplo>" en la shell este es el metodo que atendera la peticion
 	 *el servidor encargado de enviar la informacion de un archivo sera el UDP */
 	void infor(char* name)
 	{
 		int sockfd;
 		struct sockaddr_in serveraddr;
	...
	/*En caso de que el cliente digite "traer<archivox.ejemplo>" en la shell este es el metodo que atendera la peticion
 	 *el servidor encargado de enviar la informacion de un archivo sera el TCP */
